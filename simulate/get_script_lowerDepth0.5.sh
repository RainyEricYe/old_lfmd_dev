...
# select 0.5
  cat ./bin/fragN | while read a;do echo perl ./bin/randomSelect.pl ../../../2.simulate.$1/0.data/t.$a\_1.fq.gz ../../../2.simulate.$1/0.data/t.$a\_2.fq.gz ../0.data/t.$a\_1.fq.gz ../0.data/t.$a\_2.fq.gz -f 0.5;done > run_select0.5.sh
