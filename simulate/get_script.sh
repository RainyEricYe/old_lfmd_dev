...
# select 0.5
#  cat ./bin/fragN | while read a;do echo perl randomSelect.pl ../../4.simu.endHighErr.lessMut/0.data/t.$a\_1.fq.gz ../../4.simu.endHighErr.lessMut/0.data/t.$a\_2.fq.gz ../0.data/t.$a\_1.fq.gz ../0.data/t.$a\_2.fq.gz -f 0.5;done > run_select0.5.sh
# split.pl run_select0.5.sh -p se -q small -m 4G -W 2:00:00
